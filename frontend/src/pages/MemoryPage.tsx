...
import type { MemoryApiItem, ProjectApiItem } from '../types/api';
  ...
  const conversationOptions = useMemo(
    () =>
      conversations.map((conversation) => ({
        label: `${conversation.title || '新会话'} · ${conversation.messageCount} 条 · ${formatBeijingTime(conversation.updatedAt)}`,
