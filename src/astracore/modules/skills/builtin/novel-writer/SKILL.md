...
name: novel-writer
description: |
  网文写作协作 Skill。专注长篇网络小说的全流程创作，提供选题调研、框架设计、分卷分章写作、状态追踪和质量自检。USE WHEN 用户要写长篇小说（目标 5 万字以上）、建立小说框架、规划卷章结构，或延续已有长篇稿件。DO NOT USE for 短篇故事/散文/单篇文章（→ writer）或知识性叙事（→ storyteller）；不处理非小说创作任务。
metadata:
  display_name: "小说写作大师"
  order: "65"
  category: "writing"
