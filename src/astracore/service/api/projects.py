...
from astracore.core.domain.memory import ConversationProjectBinding, Project
...
@router.get("/conversations/{conversation_id}/project", response_model=ConversationProjectResponse | None)
