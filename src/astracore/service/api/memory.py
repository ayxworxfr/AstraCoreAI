...
from astracore.core.domain.memory import MemoryScope, MemoryStatus, MemoryType, StructuredMemory
...
class MemoryCreate(BaseModel):
    ...
    type: Literal["fact", "preference", "decision", "constraint", "state", "plan", "summary", "lesson"]
...
class MemoryUpdate(BaseModel):
    ...
    type: Literal["fact", "preference", "decision", "constraint", "state", "plan", "summary", "lesson"] | None = None
...
async def list_memory(
    ...
    return MemoryListResponse(items=[_to_response(memory) for memory in memories], total=len(memories))
