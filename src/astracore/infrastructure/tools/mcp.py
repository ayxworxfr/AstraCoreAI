...
from astracore.infrastructure.tools._coerce import build_param_type_map, coerce_tool_arguments
...
class MCPToolAdapter(ToolAdapter):
    ...
    def __init__(self, server_configs: list[MCPServerConfig]) -> None:
        ...
        self._locks: dict[str, asyncio.Lock] = {cfg.name: asyncio.Lock() for cfg in server_configs}
