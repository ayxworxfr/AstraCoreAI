...
from astracore.core.ports.llm import LLMAdapter
from astracore.core.ports.memory_store import MemoryStore
...
class MemoryEngine:
    ...
    async def extract_and_store(
        ...
        *,
        ...
        await self.compact_session_memories(session_id=session_id, llm_adapter=llm_adapter, model=model)
        return extracted or []
    ...
    async def _extract_with_llm(
        ...
        *,
        ...
        project_id = binding.project_id if binding is not None and scope == MemoryScope.PROJECT else None
    ...
    async def _consolidate_candidate(
        ...
        *,
        ...
        same_subject = [
            ...
            if subject_key and self._subjects_match(subject_key, self._normalize_key(memory.subject))
        ]
        exact = [
