...
def _repair_json(tool_name: str, raw: str, original_exc: _json_stdlib.JSONDecodeError) -> dict[str, Any]:
    ...
    try:
        ...
        if isinstance(repaired, dict):
            logger.warning(
                ...
                tool_name, original_exc.msg, original_exc.pos, len(raw), raw[:200],
            )
            return repaired
    except ImportError:
        pass
                ...
                if event.type == "content_block_start":
                    ...
                    if buf and buf.get("kind") == "tool":
                        ...
                        try:
                            ...
                            arguments = _repair_json(buf["name"], raw_input, exc)
